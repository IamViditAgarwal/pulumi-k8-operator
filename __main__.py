...
# fOLDER 1: global modules : pg_bucket , pg-lb .....
# folder 2 : invokations :: loop function -> call module : passing args 

# user exposed : resource config yaml : bucket-name , region ....  - bucket.yaml 
# lb.yaml - 
# firewall.yaml